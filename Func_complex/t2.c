/*
Ejercicio 2: Determinar funciones de Complejidad.
Nombre: Edgar Garcia Marciano, Grupo:3CM12.
Version 1 de prueba manual.
Ejecucion del programa:
compilacion: gcc t2.c -o t2
Ejecucion: ./t2 
Cuando sea ejecutado desplegara un menu con las opciones y segun el codigo elegido le pedira la n y le imprimira el tiempo de ejecucion y la memoria.
*/
#include <stdlib.h>
#include <stdio.h>
